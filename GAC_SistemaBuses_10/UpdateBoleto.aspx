<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateBoleto.aspx.cs" Inherits="GAC_SistemaBuses_10.UpdateBoleto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div>
        <h2>Actualización de Boletos</h2>
        <p>&nbsp;</p>
        ...
        <div class="p-1">
                <div>
                    ...
                    <asp:Button class="btn btn-danger btn-lg" ID="btn_Actualizar" runat="server" Text="Guardar" OnClick="btn_Actualizar_Click"/>         
                </div>  
        </div>
