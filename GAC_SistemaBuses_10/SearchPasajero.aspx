<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SearchPasajero.aspx.cs" Inherits="GAC_SistemaBuses_10.SearchPasajero" %>
            ...
            <tr>
             ...
             <tr>
                    <td>
                        ...
                        <asp:UpdatePanel ID="udp_Pasajeros" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gv_Pasajeros" runat="server" AutoGenerateColumns="False" CellPadding="4" CellSpacing="2" EmptyDataText="No se encontró ningun registro" ForeColor="#333333" GridLines="Vertical" Height="62px" HorizontalAlign="Center" OnRowCommand="gv_Pasajeros_RowCommand" Width="1035px">
                                    <AlternatingRowStyle BackColor="White" HorizontalAlign="Left" VerticalAlign="Middle" />
                                    <Columns>
                                        <asp:BoundField DataField="id_pasajero" HeaderText="Id_Pasajero" />
