<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SearchOperador.aspx.cs" Inherits="GAC_SistemaBuses_10.SearchOperador" %>
            ...
            <tr>
             ...
             <tr>
                    <td>
                        ...
                        <asp:UpdatePanel ID="udp_Operadores" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="gv_Operadores" runat="server" AutoGenerateColumns="False" CellPadding="4" CellSpacing="2" EmptyDataText="No se encontró ningun registro" ForeColor="#333333" GridLines="Vertical" Height="62px" HorizontalAlign="Center" OnRowCommand="gv_Operadores_RowCommand" Width="879px">
                                    <AlternatingRowStyle BackColor="White" HorizontalAlign="Left" VerticalAlign="Middle" />
                                    <Columns>
                                        <asp:BoundField DataField="id_operador" HeaderText="Id_Operador" />
