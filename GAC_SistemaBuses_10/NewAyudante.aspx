<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewAyudante.aspx.cs" Inherits="GAC_SistemaBuses_10.NewAyudante" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div>
        <h2>Registro de Ayudantes</h2>
        <p>&nbsp;</p>
